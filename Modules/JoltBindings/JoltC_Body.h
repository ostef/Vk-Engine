...
void JPH_Body_ApplyBodyCreationSettings(JPH_Body *body, const JPH_BodyCreationSettings &inBodyCreationSettings, const JPH_BroadPhaseLayerInterface *bplInterface);
JPH_SoftBodyCreationSettings JPH_Body_GetSoftBodyCreationSettings(const JPH_Body *body);
void JPH_Body_ApplySoftBodyCreationSettings(JPH_Body *body, const JPH_SoftBodyCreationSettings &inSoftBodyCreationSettings, const JPH_BroadPhaseLayerInterface *bplInterface);
